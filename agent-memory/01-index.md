...
updated_at: 2026-09-15T08:25:43+08:00
priority: critical
...
- procedures/checklist-仓库脚本清单.md | medi | 2026-09-15 | MEMORY 仓库 scripts/ 下可复用脚本一览（git-hooks 提交信息违禁词钩子、claude-rc systemd 托管 Remote Con… | scripts、git-hooks、commit-msg
