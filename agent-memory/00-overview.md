...
- 最近一次重要变化：2026-09-12 07:00 **记忆目录迁至独立仓库** `~/dev/projects/peterq/agent-memory-osec-spider`（COMMON 内 AGENTS.md/CLAUDE.md/agent-memory 改为软链接，记忆 commit 改在该仓库进行，见 `03-project-context.md`）。上一条：
