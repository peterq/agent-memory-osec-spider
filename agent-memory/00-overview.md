...
- 09-13 **新版 FC Chrome 上线**（`nc-app-prod-cdp3`，`/cdp3/*`）；**14:30 挂 NAS**（`app-20260913h`）：`CDP3DATA=/mnt/nas/apps/cdp3`、`CDP3TEMP`、`extensions=`、`profile=ns/name`（调用方须发 `Browser.close`）。→ `decisions/decision-2026-09-13-cdp3持久化会话与扩展机制.md`
